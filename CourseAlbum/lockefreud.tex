...
\node[root concept] {Modernity: From Locke to Freud}
  ...
  child [concept color=scibg,text=black] { node {Arts}
	...
	child [concept ] { node {Paintings}
		child { node {\hrefmm{http://en.wikipedia.org/wiki/Romanticism}{black}{Romantis\-cism}}
		...
		child { node {\hrefmm{http://en.wikipedia.org/wiki/Impressionism}{black}{Impres\-sionism}}
