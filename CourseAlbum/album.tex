...
\resizebox{!}{.95\textheight}{\includegraphics{Eugene_Delacroix_-_Le_Massacre_de_Scio}}
\end{myframe}
...
\resizebox{!}{.92\textheight}{\includegraphics{Gustave_Courbet_-_self_(1843)}}
\end{myframe}
...
\resizebox{!}{.92\textheight}{\includegraphics{Gustave_Courbet_040.jpg}}
\end{myframe}
...
\resizebox{!}{.76\textheight}{\includegraphics{Courbet_Sleep.jpg}}
\end{myframe}
...
\resizebox{0.87\textwidth}{!}{\includegraphics{Edouard_Manet_-_Segelboote_in_Argenteuil.jpg}}
\end{myframe}
...
\resizebox{!}{.92\textheight}{\includegraphics{Edouard_Manet_-_Le_Chemin_de_fer_-_Google_Art_Project.jpg}}
\end{myframe}
...
\resizebox{!}{.89\textheight}{\includegraphics{Edouard_Manet_-_Le_Dejeuner_sur_lherbe.jpg}}
\end{myframe}
...
\resizebox{!}{.92\textheight}{\includegraphics{Gustave_Courbet_033.jpg}}
\end{myframe}
...
\resizebox{.88\textwidth}{!}{\includegraphics{Constantin-Ernest-Adolphe-Hyacinthe_Guys_001.jpg}}
\end{myframe}
...
\resizebox{.88\textwidth}{!}{\includegraphics{Edouard_Manet,_A_Bar_at_the_Folies-Bergere.jpg}}
\end{myframe}
