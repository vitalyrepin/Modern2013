...
\newcommand{\pict}[1]{\includegraphics[keepaspectratio,width=.87\textwidth,height=.95\textheight]{#1}}
...
\includegraphics[keepaspectratio,width=.87\textwidth,height=.9\textheight]{Gustave_Courbet_033.jpg}
\end{myframe}
