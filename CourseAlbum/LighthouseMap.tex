...
\phantomsection
\addcontentsline{toc}{subsection}{To the Lighthouse by Virginia Woolf. Mindmap}

\index{Virginia Woolf}
\index{To the Lighthouse}

\pgfdeclarelayer{background}
\pgfsetlayers{background,main}
\begin{center}
\copyrightboxOddEven{\resizebox{!}{.93\textheight}{\begin{tikzpicture}[mindmap,
