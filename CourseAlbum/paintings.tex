...
\newcommand{\newartist}[2]{\stepcounter{artist}\pdfbookmark[3]{#1}{\arabic{artist}}\addcontentsline{toc}{subsection}{#1 #2}\index{#1}}
...
\myhref{#6}{\textsf{\textbf{#1 (#2, #3).}}} \textit{#4.} #5.\index{#2@#2 (#1), \textsl{painting}}\bigskip}
