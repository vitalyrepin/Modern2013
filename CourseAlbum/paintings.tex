...
\newcommand{\newartist}[2]{\stepcounter{artist}\pdfbookmark[3]{#1}{\arabic{artist}}\addcontentsline{toc}{subsection}{#1 #2}\index{#1}\def\currArtist{#1}}
...
\myhref{#6}{\textsf{\textbf{#1 (#2, #3).}}} \textit{#4.} #5.\index{#2@#2 (#1), \textsl{painting}}\index{\currArtist}\bigskip}
...
\newcommand{\pictRaw}[3][]{\label{img:#3.jpg}\copyrightbox[#2]{\includegraphics[#1 keepaspectratio,width=.89\textwidth,height=.9\textheight]{imgs/#3}}{\centerline{\tiny\sffamily\license}}}
...
\end{center}
\vspace*{-.7cm}
\centerline{\pict{Eugene_Delacroix_-_Le_28_Juillet_La_Liberte_guidant_le_peuple}}
\newpage
...
\end{center}
\vspace*{-.7cm}
\centerline{\pict{Gustave_Courbet_033}}
\newpage
...
\pictRaw{b}{Gustave_Courbet_-_A_Burial_at_Ornans_-_Google_Art_Project_2}
\end{myframe}
...
\pict{Edouard_Manet_-_Segelboote_in_Argenteuil}
\end{myframe}
...
\pict{MANET_-_Musica_en_las_Tullerias_(National_Gallery,_Londres,_1862)}
\end{myframe}
...
\pict{Edouard_Manet_-_Le_Chemin_de_fer_-_Google_Art_Project}
\end{myframe}
...
\pict{Edouard_Manet_-_Le_Dejeuner_sur_lherbe}
\end{myframe}
...
\pict{Edouard_Manet_-_Olympia_-_Google_Art_Project_3}
\end{myframe}
...
\pict{Edouard_Manet,_A_Bar_at_the_Folies-Bergere}
\end{myframe}
...
\pict{Constantin-Ernest-Adolphe-Hyacinthe_Guys_001}
\end{myframe}
...
\end{center}
\vspace*{-.6cm}
\centerline{\pict{Camille_Pissarro_045}}
\newpage
...
\pict{Camille_Pissarro,_Gelee_blanche_(Hoarfrost),_1873}
\end{myframe}
...
\pictR{Henri_de_Toulouse-Lautrec_019}
\end{myframe}
...
\pictR{Henri_de_Toulouse-Lautrec_014}
\end{myframe}
...
\pict{Henri_de_Toulouse-Lautrec_009}
\end{myframe}
...
\let\license\publicDomainWorld
\pict{Edgar_Germain_Hilaire_Degas_084}
\end{myframe}
...
\let\license\publicDomainWorld
\pict{Edgar_Germain_Hilaire_Degas_032}
\end{myframe}
...
\let\license\publicDomainWorld
\pict{Edgar_Germain_Hilaire_Degas_029}
\end{myframe}
...
\let\license\publicDomainWorld
\pict{Edgar_Germain_Hilaire_Degas_045}
\end{myframe}
...
\let\license\publicDomainWorld
\pictR{Edgar_Germain_Hilaire_Degas_012}
\end{myframe}
...
\pictR{Cezanne_-_Selbstbildnis_mit_Mutze}
\end{myframe}
...
\end{center}
\vspace*{-.8cm}
{\let\license\publicDomainWorld\centerline{\pict{Paul_Cezanne_109}}}
\newpage
...
\end{center}
\vspace*{-.8cm}
\centerline{\pict{Cezanne_-_Mont_Sainte_Victoire_von_Lauves_aus_gesehen_2}}
\newpage
...
\pictR{1913_Gris_violin_and_guitar_anagoria}
\end{myframe}
...
\let\license\publicDomainEighty
\pictR{1914_Gris_Le_Petit_Dejeuner}
\end{myframe}
